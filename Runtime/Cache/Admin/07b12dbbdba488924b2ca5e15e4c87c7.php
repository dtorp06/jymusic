...
<div class="col-md-4">
	<div class="input-group mb-lg search-form">
    	...
    	<a class="input-group-addon btn" id="search" url="<?php echo U('Artist/index',false,false);?>">
    	...
    	<div class="panel panel-default">
       		<div class="panel-heading ">艺术家列表
				<div class="btn-group ml-lg">
					...
					<?php if(is_array($positions)): foreach($positions as $k=>$pos): ?><a class="mr-sm ml-sm <?php if(!empty($_GET['pos'])): if(($_GET['pos']) == $k): ?>text-danger<?php endif; endif; ?>" href="<?php echo U('index?pos='.$k);?>"><?php echo ($pos); ?></a><?php endforeach; endif; ?>]
       			</div>
...
<script type="text/javascript">
	//导航高亮
	highlight_subnav("<?php echo U('Songs/index');?>","<?php echo U('Artist/index');?>")
