...
<div class="panel panel-default">
	<div class="panel-heading"><?php echo isset($data['id'])?'编辑':'新增';?>歌曲</div>
 	<div class="panel-body">
        <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo U();?>" name="songs"  method="post">	
       		<div class="form-group">	
				...
				<div class="col-sm-3">
					<input  type="text"  name="name" value="<?php echo ((isset($data["name"]) && ($data["name"] !== ""))?($data["name"]):''); ?>" class="form-control">					
				</div>
			...
			<div class="form-group">	
				...
				<div class="col-sm-5">
					<input type="text"  class="form-control" name="disk_url"  value="<?php echo ((isset($data["disk_url"]) && ($data["disk_url"] !== ""))?($data["disk_url"]):""); ?>"> 
				</div>
				<div class="col-sm-2 pr0" >
					<input type="text" class="form-control" placeholder="网盘密码" name="disk_pass" value="<?php echo ((isset($data["disk_pass"]) && ($data["disk_pass"] !== ""))?($data["disk_pass"]):""); ?>">
				</div>
			</div>
			...
			<div class="form-group">	
    			...
    			<div class="col-sm-1">
    				<input type="text" class="form-control"  value="<?php echo ((isset($data["coin"]) && ($data["coin"] !== ""))?($data["coin"]):'0'); ?>" name="coin">    				
    			</div>				
    		...
    		<div class="form-group">
		        ...
		        <div class="col-sm-6">
		        	<?php if(is_array($positions)): foreach($positions as $k=>$pos): ?><div class="checkbox c-checkbox inline mr-sm">
				    	<label>	
							<?php if(!empty($data['position'])): if($k & $data['position']): ?><input type="checkbox" checked name="position[]" value="<?php echo ($k); ?>">
								<?php else: ?>
								<input type="checkbox" name="position[]" value="<?php echo ($k); ?>"><?php endif; ?>								
							<?php else: ?>
								<input type="checkbox" name="position[]" value="<?php echo ($k); ?>"><?php endif; ?>				    				             				             	
							<span class="fa fa-check"></span>
			             	<?php echo ($pos); ?>
				...
				<!--div class="form-group">	
					...
					<div class="col-sm-2">				
						<div class="input-group">
							<input type="text" class="form-control" name="lyrics"  value="<?php echo ((isset($data["lyrics"]) && ($data["lyrics"] !== ""))?($data["lyrics"]):''); ?>">	
						</div>
					</div>	
					<label class="col-sm-1 control-label">作曲</label>			
					<div class="col-sm-2">
						<div class="input-group">
							<input type="text" class="form-control"  name="composer" value="<?php echo ((isset($data["composer"]) && ($data["composer"] !== ""))?($data["composer"]):''); ?>">
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<div class="input-group">
							<input type="text" class="form-control"  name="sing" value="<?php echo ((isset($data["sing"]) && ($data["sing"] !== ""))?($data["sing"]):''); ?>">
						</div>
					</div>	
					<label class="col-sm-1 control-label">编曲</label>
					<div class="col-sm-2">
						<div class="input-group">	
							<input type="text" class="form-control"  name="midi"  value="<?php echo ((isset($data["midi"]) && ($data["midi"] !== ""))?($data["midi"]):''); ?>">	
						</div>                   
					</div>
					<label class="col-sm-1 control-label">混缩</label>
					<div class="col-sm-2">
						<div class="input-group">	
							<input type="text" class="form-control"  name="mix"  value="<?php echo ((isset($data["midi"]) && ($data["midi"] !== ""))?($data["midi"]):''); ?>">	
						</div>                   
					</div>						
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-2 controls">
						<input type="text" class="form-control"  value="<?php echo ((isset($data["digg"]) && ($data["digg"] !== ""))?($data["digg"]):'0'); ?>" name="digg">
					</div>	
			
					<label class="col-sm-1 control-label ">踩次数</label>
					<div class="col-sm-2">
						<input type="text" class="form-control"  value="<?php echo ((isset($data["bury"]) && ($data["bury"] !== ""))?($data["bury"]):'0'); ?>" name="bury">    				
					</div>
				</div>	
				<div class="form-group">
					<label class="col-sm-2 control-label ">收藏次数</label>
					<div class="col-sm-2">
						<input type="text" class="form-control"  value="<?php echo ((isset($data["favtimes"]) && ($data["favtimes"] !== ""))?($data["favtimes"]):'0'); ?>" name="favtimes">    				
					</div>
					
					<label class="col-sm-1 control-label ">喜欢数</label>
					<div class="col-sm-2 controls">
						<input type="text" class="form-control"  value="<?php echo ((isset($data["likes"]) && ($data["likes"] !== ""))?($data["likes"]):'0'); ?>" name="likes">
					</div>	
			
					<label class="col-sm-1 control-label ">评论数</label>
					<div class="col-sm-2">
						<input type="text" class="form-control"  value="<?php echo ((isset($data["comment"]) && ($data["comment"] !== ""))?($data["comment"]):'0'); ?>" name="comment">    				
					</div>		    							
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label ">文件大小</label>
					<div class="col-sm-2">
						<input type="text" class="form-control"  value="<?php echo ((isset($data["file_size"]) && ($data["file_size"] !== ""))?($data["file_size"]):''); ?>" name="file_size">    				
					</div>
					
					<label class="col-sm-1 control-label ">比特率</label>
					<div class="col-sm-2 controls">
						<input type="text" class="form-control"  value="<?php echo ((isset($data["bitrate"]) && ($data["bitrate"] !== ""))?($data["bitrate"]):''); ?>" name="bitrate">
					</div>
					
					<label class="col-sm-1 control-label ">时长</label>
					<div class="col-sm-2 controls">
						<input type="text" class="form-control"  value="<?php echo ((isset($data["play_time"]) && ($data["play_time"] !== ""))?($data["play_time"]):''); ?>" name="play_time">
					</div>						
				</div-->
			...
			<div class="form-group">	
				...
				<div class="col-sm-7">
					<textarea  name="lrc" class="form-control"><?php echo ((isset($data["lrc"]) && ($data["lrc"] !== ""))?($data["lrc"]):''); ?></textarea>				
				</div>
			</div>
			<div class="form-group">	
				<label class=" col-sm-2 control-label">介绍</label>
				<div class="col-sm-7">
					<textarea  name="introduce" class="form-control"><?php echo ((isset($data["introduce"]) && ($data["introduce"] !== ""))?($data["introduce"]):''); ?></textarea>
				</div>
