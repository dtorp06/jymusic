...
<div class="col-md-4">
	<div class="input-group mb-lg">
    	<input type="text" name="title" class="form-control" value="<?php echo I('title');?>" placeholder="请输入信息内容">
    	<span class="input-group-addon">    		
        	<a class="fa-search fa" href="javascript:;" id="search" url="/admin.php?s=/message/index.html"></a> 
    	</span>
	</div>
</div>
<div class="row">
    <div class="col-md-12">
    	<div class="panel panel-default">
       		<div class="panel-heading ">信息列表
       			 [
				<?php if(($type) == "letter"): ?><span class="mr-sm">私信</span><?php else: ?><a  href="<?php echo U('index?type=letter');?>">私信</a><?php endif; ?>
				 
				 <?php if(($type) == "notice"): ?><span class="mr-sm">系统</span><?php else: ?><a class="mr-sm"  href="<?php echo U('index?type=system');?>">系统</a><?php endif; ?>
					
				  ] 
       			
       			<div class="btn-group pull-right">
	       			<a class="btn btn-labeled btn-success" href="<?php echo U('add');?>">发送通知</a>               
					...
					<table class="table table-bordered table-striped">
            			...
            			<tbody>
            				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            						...
            						<td><?php echo (msubstr($vo["content"],0,20)); ?></td>
            						<td>
									<?php if(!empty($vo['to_uname'])): echo ($vo['to_uname']); ?>
									<?php else: ?>
										<?php echo (get_nickname($vo['to_uid'])); endif; ?>
									</td>
            						<td> 
            							<?php if($vo["is_read"] == 1): ?><span style="color:#63930A">已读</spna>		        						
			        					<?php else: ?>
			        						未读<?php endif; ?>	
		        					</td>
    	                            ...
    	                            <a class="btn btn-danger btn-xs btn-del" url="<?php echo U('del?ids='.$vo['id']);?>">删除</a>
            						</td>
...
<script type="text/javascript">
    ...
    //导航高亮
    highlight_subnav("<?php echo U('Message/index');?>");
	</script>
