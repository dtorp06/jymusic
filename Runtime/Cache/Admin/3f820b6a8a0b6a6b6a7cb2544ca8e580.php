...
<h3 class="col-md-8">SEO规则管理</h3>
<div class="row">
    <div class="col-lg-12">
    	<div class="panel panel-default">
       		<div class="panel-heading ">规则管理
        		...
        		<table class="table table-striped table-bordered table-hover">           
                    ...
                    <tbody>
                    	<?php if(!empty($list)): if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($k % 2 );++$k;?><tr>
                        	...
                        	<td><?php echo ($data["title_rule"]); ?></td>
                        	<td><?php echo ($data["keywords_rule"]); ?></td>
                        	<td><?php echo ($data["description_rule"]); ?></td>
...
<script type="text/javascript">
	//导航高亮
	highlight_subnav("<?php echo U('Config/group');?>","<?php echo U('Seo/index');?>");
</script>
