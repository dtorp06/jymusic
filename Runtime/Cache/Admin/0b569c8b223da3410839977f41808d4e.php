    	...
    	<div class="panel panel-default">
       		<div class="panel-heading ">行为日志
       			<div class="btn-group pull-right"> 
	                <a class="btn btn-labeled btn-danger ajax-post" url="<?php echo U('clear');?>" target-form="ids">清空</a>
					<a class="btn btn-labeled btn-danger ajax-post" url="<?php echo U('remove');?>" target-form="ids">删除</a>
...
<script type="text/javascript">
$(function(){
highlight_subnav("<?php echo U('User/index');?>","<?php echo U('Action/actionlog');?>");
})
</script>
