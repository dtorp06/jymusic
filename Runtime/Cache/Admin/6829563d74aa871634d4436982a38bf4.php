...
<h3 class="col-md-8">曲风管理</h3>
<div class="row">
    <div class="col-lg-12">
    	<div class="panel panel-default">
       		<div class="panel-heading ">曲风列表
        		...
        		<table class="table table-striped table-bordered table-hover">           
                    ...
                    <tbody>
                    	<?php if(!empty($list)): if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($k % 2 );++$k;?><tr>
        					...
        					<td><?php echo (get_genre_name($data["pid"])); ?></td>
        					<td>
        					<?php if($data["recommend"] == 0): ?>否
        					<?php else: ?>
        						<span style="color:#63930A">是</spna><?php endif; ?>
        					</td>    
