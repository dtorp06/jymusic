			...
			<div class="row clearfix">
				...
				<div class="col-md-5 col-sm-8 t_align_c ">
					<div class="search-box mt_15" >
						<form role="search" class="relative type_2" id="search_form" method="get" action="<?php echo U('/search');?>">
	...
	<div class="container">	
		<div class="row clearfix">
			...
			<section class="col-sm-8">
						...
						<div class="col-sm-4">											
							<div class="photoframe shadow wrapper mb_10">
								<div class=" thumbnail mb_0">
									<a  href="<?php echo ($data['user_url']); ?>"><img src="<?php echo (get_user_avatar($data['up_uid'],"256")); ?>" class="tr_all_hover"></a>
								</div>
							</div>										
						</div>
						<div class="col-sm-8">
							<h2 class="pt_10 text-ellipsis">
								...
								<i class="jy jy-play-f"></i></a><?php echo ($data["artist_name"]); ?> - <?php echo ($data["name"]); ?>
							</h2>
							<div class="clearfix mt_10">
								<ul class="">
									<li class="mb_10">分享:<a href="<?php echo ($user['url']); ?>"><?php echo ($user['nickname']); ?></a></li>
									<li class="mb_10">点击:<?php echo ($data['listens']); ?></a></li>
									<li class="mb_10">标签:
										<?php $stags = M("MusicTag")->where(array("type"=>1,"music_id"=>$data['id']))->getField("tag_id",true);$_result = !empty($stags)? M("Tag")->where(array("id"=>array("in",$stags)))->limit(10)->select() :null;if($_result):$k=0;foreach($_result as $key=>$t): $t['url']= !empty($t["alias"])? U('/tag/'.$t['alias']): U('/Tag/'.$t['id']);++$k;$mod = ($k % 2 ); if(($k) != "1"): ?>/<?php endif; ?>
										<a href="<?php echo ($t['url']); ?>"><?php echo ($t['name']); ?></a><?php endforeach; endif;?>
									</li>								
								</ul>
							</div>
							...
							<div class="clearfix mb_20">
								<ul class="horizontal_list l_width_divider">
									<li class="mr_15">专辑:<a href="<?php echo ($data['album_url']); ?>"><?php echo ((isset($data["album_name"]) && ($data["album_name"] !== ""))?($data["album_name"]):"单曲"); ?></a></li>
									<li class="mr_15">歌手:<a href="<?php echo ($data['artist_url']); ?>"><?php echo ($data["artist_name"]); ?></a></li>
									<li class="mr_15">类别:<a href="<?php echo ($data['genre_url']); ?>"><?php echo ($data["genre_name"]); ?></a></li>								
								</ul>
							</div>
							<ul class="horizontal_list clearfix mb_10">
								<li class="mr_5">									
									<a href="javascript:;"  class="btn_1 f_right relative music-action-btn <?php if(is_fav($data['id'])): ?>on<?php endif; ?>" data-id="<?php echo ($data['id']); ?>" data-action="fav">
								...
								<li class="mr_5">									
									<a href="javascript:;"  class="btn_1 f_right relative music-action-btn" data-id="<?php echo ($data['id']); ?>" data-action="like">
										<span class="tooltip tr_all_hover">喜欢[<span class="num"><?php echo ($data["likes"]); ?></span>]</span>
										<i class="jy jy-like"></i>
									</a>								
								</li>
								<li class="mr_5">
									<a href="javascript:;"  class="btn_1 f_right relative music-action-btn" data-id="<?php echo ($data['id']); ?>" data-action="digg">
										<span class="tooltip tr_all_hover">赞[<span class="num"><?php echo ($data["digg"]); ?></span>]</span>
										<i class="jy jy-digg"></i>
									</a>
								</li>
								<li class="mr_5">
									<a class="down btn_1 f_right relative tr_delay_hover" target="_down" href="<?php echo U('Down/index?id='.$data['id']);?>">
										<span class="tooltip tr_all_hover">下载[<span class="num"><?php echo ($data["download"]); ?></span>]</span>
										<i class="jy jy-cloud-down"></i>
									</a>
								</li>
								
								<li class="f_right mt_10">
								<?php $next = M("Songs")->field("id,name")->order("id")->where(array("status"=>1,"id"=> array("gt", $data["id"])))->find();if(empty($next)): $next = M("Songs")->field("id,name")->order("id ASC")->find();?> <?php endif; ?> <?php $next['url']=U('/Music/'.$next['id']); ?>  <a class="btn_1" href="<?php echo ($next['url']); ?>" class="btn pull-right jp-next">下一曲</a>
								</li>
								<li class="f_right mr_5 mt_10">
								<?php $prev = M("Songs")->field("id,name")->order("id DESC")->where(array("status"=>1,"id"=> array("lt", $data["id"])))->find();if(empty($prev)): $prev = M("Songs")->field("id,name")->order("id DESC")->find();?>  <?php endif; $prev['url']=U('/Music/'.$prev['id']); ?>  <a class="btn_1"href="<?php echo ($prev['url']); ?>" class="btn pull-right jp-previous">上一曲</a>
								</li>
							</ul>
					...
					<div class="clearfix">
						<?php echo hook('documentDetailAfter',array('type'=>'song','id'=>$data['id']));?>
					</div>
	
			</section>	
			<aside class="col-sm-4">
				<?php if(!empty($data['lrc'])): endif; ?>
		...
		<div class="container">
			<div class="row clearfix">
				...
				<div class="col-sm-2">
					...
					<ul class="vertical_list">
						...
						<li><i class="jy jy-music f_left"></i><a class="contact_e" href="http://www.jyuu.cn">JYmusic音乐网站管理系统</a></li>
					</ul>
				</div>
			</div>
			<hr>
			<div class="row clearfix">
				...
				<div class="footer_bottom_part col-sm-6 ">
						<p class="f_left"> Powered by<a style="color: #ff7f9a;" href="http://www.jyuu.cn">JYmusic</a>&copy; <?php echo date('Y');?></p>
						<p class="f_left">
