...
<div class="page_content_offset">
	<div class="down_page container">
		<section class="col-sm-9 m_xs_bottom_10">
			...
			<div class="row clearfix pt_10">	
				...
				<div class="col-lg-9 col-md-9 col-sm-12">				
					<div class="f_left">
						<img height="70" width="70" src="<?php echo ($data["cover_url"]); ?>">
					</div>
						
					<div class="f_left ml_20">
						<h4 class="mb_20">
							<?php if($data["artist_id"] != '0'): echo ($data["artist_name"]); ?> --<?php endif; ?>
							<?php echo ($data["name"]); ?>
						</h4>
						<div class="mb_10"><?php echo hook('pageBody',array('widget'=>'Baidushare'));?></div>
					</div>
				</div>
				
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					<a class="mb_10 down_muisc d_block btn_1 text-center" onclick="downMusic(<?php echo ($data['id']); ?>)" href="javascript:;">
						<span class="d_inline_middle">
							<b>本地高速下载1</b>
						</span>
					</a>
					
					<a class="d_block down_muisc btn_1 text-center" onclick="downMusic(<?php echo ($data['id']); ?>)" href="javascript:;">
						<span class="d_inline_middle">
							<b>本地高速下载2</b>
						</span>
					</a>
			...
			<div class="row clearfix mb_20 pt_10">
				<div class=" col-lg-6 col-md-6 col-sm-12">
					<span class="mb_15 d_block">上传会员：<a href="<?php echo ($data['user_url']); ?>"><?php echo ($data["up_uname"]); ?></a></span>
					<span class="mb_15 d_block">所属专辑：<a href="<?php echo ($data['album_url']); ?>"><?php echo ($data["album_name"]); ?></a></span>
					<span class="mb_15 d_block">所属艺人：<a href="<?php echo ($data['artist_url']); ?>"><?php echo ($data["artist_name"]); ?></a></span>
					<span class="mb_15 d_block">所属曲风：<a href="<?php echo ($data['genre_url']); ?>"><?php echo ($data["genre_name"]); ?></a></span>
				</div>	
				<div class=" col-lg-6 col-md-6 col-sm-12">						
					<span class="mb_15 d_block">下载次数：<?php echo ($data["download"]); ?></span>
					<span class="mb_15 d_block">试听次数：<?php echo (number_format($data["listens"])); ?></span>
					<span class="mb_15 d_block">收藏次数：<?php echo ($data["favtimes"]); ?></span>
				</div>
			</div>
			<hr class="mb_10 ">
			<div class="row clearfix pt_10">					
			...
			<div class="row clearfix mb_20 pt_10">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<span class="mb_15 d_block">需要登录才可以下载，左键单击下载按钮即可下载，不能使用右键另存为</span>
					<span class="mb_15 d_block">如果还没账号的请点上方注册按钮</span>
					<span class="mb_15 d_block">如果还没登录的请点上方登录按钮</li>
				</div>							
			</div>
