	...
	<div class="container">
		<div class="row clearfix">
			<section class="col-sm-4 col-sm-offset-4 col-xs-10 col-xs-offset-1 login-box" >
				...
				<hr>
				<!--login form-->
				<form method="post" name="validator-form" action="<?php echo U('member/login');?>" class="form-horizontal">
					<ul>
						...
						<li class="mb_15">
							...
							<span><a class="f_right ml_10" href="<?php echo U('Member/findpwd');?>">忘记密码?</a></span>
						</li>
						<li>
